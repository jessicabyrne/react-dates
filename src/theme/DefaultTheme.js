...
export default {
  reactDates: {
    ...
    color: {
      ...
      hoveredSpan: {
        backgroundColor: core.mdcThemePrimaryShade_4,
        backgroundColor_active: core.mdcThemePrimaryShade_3,
        backgroundColor_hover: core.mdcThemePrimaryShade_4,
      ...
      selectedSpan: {
        backgroundColor: core.mdcThemePrimaryShade_2,
        backgroundColor_active: core.mdcThemePrimaryShade_1,
        backgroundColor_hover: core.mdcThemePrimaryShade_1,
        borderColor: core.mdcThemePrimaryShade_1,
        borderColor_active: core.mdcThemePrimary,
        borderColor_hover: core.mdcThemePrimary,
        color: core.white,
      ...
      selected: {
        backgroundColor: core.mdcThemePrimary,
        backgroundColor_active: core.mdcThemePrimary,
        backgroundColor_hover: core.mdcThemePrimary,
        borderColor: core.mdcThemePrimary,
        borderColor_active: core.mdcThemePrimary,
        borderColor_hover: core.mdcThemePrimary,
        color: core.white,
        color_active: core.white,
